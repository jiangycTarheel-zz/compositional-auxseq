...
T5_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    "t5-2l-2h": "configs/t5-2l-2h-config.json",
}
...
class T5Config(PretrainedConfig):
    ...
    def __init__(
        ...
        pad_token_id=0,
        eos_token_id=1,
        mask_decoder_input=False,
        embedding_regularization=False,
        layer_regularization=False,
        predict_action_count=False,
        predict_action_group=False,
        predict_action_count_mode=None,
        action_count_attention_kv=None,
        **kwargs
    ):
        super().__init__(
        ...
        self.mask_decoder_input = mask_decoder_input
        self.embedding_regularization = embedding_regularization
        self.layer_regularization = layer_regularization
        self.predict_action_count = predict_action_count
        self.predict_action_group = predict_action_group
        self.predict_action_count_mode = predict_action_count_mode
        self.action_count_attention_kv = action_count_attention_kv
        if predict_action_count:
            assert action_count_attention_kv is not None
